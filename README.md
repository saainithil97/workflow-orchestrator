...
The plugin ships with 9 rule files that both Claude Code and OpenCode agents follow:

| Rule | Description |
|------|-------------|
| `workflow.md` | Pipeline stages, gating logic, completion markers |
| `tdd.md` | Red-Green-Refactor methodology |
| `code-quality.md` | 5 core review dimensions (always-on) |
| `observability.md` | OTel, structured logging, metrics, dashboards |
| `documentation.md` | Doc types, sync rules, runbook/migration standards |
| `tech-debt.md` | Broken windows policy — fix debt in files you touch |
| `review-dimensions.md` | Full 20-dimension reference (Tier 1/2/3, on demand) |
| `preamble.md` | Shared pre-work checklist (preferences, learnings, gate check, tech debt) |
| `recommended-tools.md` | Per-stage MCP server and tool recommendations |
